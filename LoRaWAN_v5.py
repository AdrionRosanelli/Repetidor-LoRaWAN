...
def transmit(env,node):
    while node.buffer > 0.0:
        ...
        rssi_base = 0
           ...
           # Verifica se o node esta no alcance do repetidor e a distancia ate o gatway
        ...
        if node.packet.repetidor == 1:
            # Pacote do node para o repetidor
